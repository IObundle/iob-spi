...
#quartus_map --parallel=1 --helper=2 --helper_type=user_partition --partition=spi_slave:spi_s spi -c spi

#quartus_map --parallel=1 --helper=1 --helper_type=user_partition --partition=spi_master:spi_m spi -c spi
