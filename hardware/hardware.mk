...
$(SPI_HW_INC_DIR)/sw_reg_gen.v: $(SPI_HW_INC_DIR)/sw_reg.v
	...
	mv sw_reg_gen.v $(SPI_HW_INC_DIR)
	mv sw_reg_w.vh $(SPI_HW_INC_DIR)

clean_hw:
	@rm -rf $(SPI_HW_INC_DIR)/sw_reg_gen.v $(SPI_HW_INC_DIR)/sw_reg_w.vh #tmp $(SPI_HW_DIR)/fpga/vivado/XCKU $(SPI_HW_DIR)/fpga/quartus/CYCLONEV-GT
